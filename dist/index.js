...
import "@marko/tags-api-preview/dist/transform/cached-function";
...
app.register(Promise.resolve().then(function() {
  return index$1;
}));
const _marko_componentType$5 = "5OvfYrpN", _marko_template$5 = t(_marko_componentType$5);
const _marko_component$5 = {};
_marko_template$5._ = _marko_renderer(function(input, out, _componentDef, _component, state) {
  const {
    renderBody,
    class: classes,
    ...otherAttrs
  } = input;
  out.w(`<svg${_marko_attrs({
    "focusable": "false",
    "width": "1.5em",
    "height": "1.5em",
    "viewBox": "0 0 24 24",
    ...otherAttrs,
    "class": _marko_class_merge(["markcons", classes])
  })}>`);
  _marko_dynamic_tag(out, renderBody, null, null, null, null, _componentDef, "1");
  out.w("</svg>");
}, {
  t: _marko_componentType$5,
  i: true
}, _marko_component$5);
const _marko_componentType$4 = "4jqvAKPE", _marko_template$4 = t(_marko_componentType$4);
const _marko_component$4 = {};
_marko_template$4._ = _marko_renderer(function(input, out, _componentDef, _component, state) {
  const {
    title,
    desc,
    ...otherAttrs
  } = input;
  _marko_tag(_marko_template$5, {
    ...otherAttrs,
    "renderBody": (out2) => {
      out2.w(`<title>${x(title)}</title><desc>${x(desc)}</desc><path d="M7 22Q6.175 22 5.588 21.413Q5 20.825 5 20Q5 19.175 5.588 18.587Q6.175 18 7 18Q7.825 18 8.412 18.587Q9 19.175 9 20Q9 20.825 8.412 21.413Q7.825 22 7 22ZM17 22Q16.175 22 15.588 21.413Q15 20.825 15 20Q15 19.175 15.588 18.587Q16.175 18 17 18Q17.825 18 18.413 18.587Q19 19.175 19 20Q19 20.825 18.413 21.413Q17.825 22 17 22ZM6.15 6 8.55 11H15.55Q15.55 11 15.55 11Q15.55 11 15.55 11L18.3 6Q18.3 6 18.3 6Q18.3 6 18.3 6ZM5.2 4H19.95Q20.625 4 20.875 4.5Q21.125 5 20.85 5.55L17.3 11.95Q17.025 12.45 16.575 12.725Q16.125 13 15.55 13H8.1L7 15Q7 15 7 15Q7 15 7 15H19V17H7Q5.875 17 5.3 16.012Q4.725 15.025 5.25 14.05L6.6 11.6L3 4H1V2H4.25ZM8.55 11 6.15 6H18.3Q18.3 6 18.3 6Q18.3 6 18.3 6L15.55 11Z" />`);
    }
  }, out, _componentDef, "0");
}, {
...
function getBarBounds(bar, useFinalPosition) {
  const { x: x2, y, base, width, height } = bar.getProps(["x", "y", "base", "width", "height"], useFinalPosition);
...
class BarElement extends Element {
  ...
  getCenterPoint(useFinalPosition) {
    const { x: x2, y, base, horizontal } = this.getProps(["x", "y", "base", "horizontal"], useFinalPosition);
    return {
...
function drawPointLabels(scale, labelCount) {
  ...
  for (let i = labelCount - 1; i >= 0; i--) {
    ...
    const { x: x2, y, textAlign, left, top, right, bottom } = scale._pointLabelItems[i];
...
const _marko_componentType$3 = "5JIeF7gE", _marko_template$3 = t(_marko_componentType$3);
const _marko_component$3 = {
  onCreate() {
    this.state = {};
  }
};
_marko_template$3._ = _marko_renderer(function(input, out, _componentDef, _component2, state) {
  out.w("<h1>chart</h1><canvas id=my-canvas width=400 height=400></canvas>");
}, {
  t: _marko_componentType$3
}, _marko_component$3);
const _marko_componentType$2 = "u9zGkcti", _marko_template$2 = t(_marko_componentType$2);
const _marko_component$2 = {};
_marko_template$2._ = _marko_renderer(function(input, out, _componentDef, _component, state) {
  out.w(`<!DOCTYPE html><html><head>${_marko_to_string(out.global.___viteRenderAssets("head-prepend"))}<meta name=viewport content="width=device-width, initial-scale=1.0">${_marko_to_string(out.global.___viteRenderAssets("head"))}</head><body direction=rtl>${_marko_to_string(out.global.___viteRenderAssets("body-prepend"))}<h1>TinyMCE Quick Start Guide</h1><div class=dashboard-stats><article class=dashboard-stat><div class=dashboard-stat-title><h2>\u05DB\u05D5\u05EA\u05E8\u05EA</h2><b>0%</b></div><div class=dashboard-stat-content>`);
  _marko_tag(_marko_template$4, {}, out, _componentDef, "11");
  out.w("<b>0</b></div><div class=dashboard-stat-footer><a href=#>\u05E4\u05E8\u05D8\u05D9\u05DD \u05E0\u05D5\u05E1\u05E4\u05D9\u05DD...</a></div></article><article class=dashboard-stat><div class=dashboard-stat-title><h2>\u05DB\u05D5\u05EA\u05E8\u05EA</h2><b>0%</b></div><div class=dashboard-stat-content>");
  _marko_tag(_marko_template$4, {}, out, _componentDef, "20");
  out.w("<b>0</b></div><div class=dashboard-stat-footer><a href=#>\u05E4\u05E8\u05D8\u05D9\u05DD \u05E0\u05D5\u05E1\u05E4\u05D9\u05DD...</a></div></article>");
  _marko_tag(_marko_template$3, {}, out, _componentDef, "24");
  out.w(`</div>${_marko_to_string(out.global.___viteRenderAssets("body"))}`);
  _marko_tag(_initComponents, {}, out, _componentDef, "25");
  _marko_tag(_awaitReorderer, {}, out, _componentDef, "26");
  _marko_tag(_preferredScriptLocation, {}, out, _componentDef, "27");
  out.w("</body></html>");
}, {
...
function renderAssets(slot) {
  ...
  if (entries) {
    ...
    for (let i = lastWrittenEntry; i < writtenEntries; i++) {
      ...
      const parts = typeof __MARKO_MANIFEST__ === "object" ? (_a = __MARKO_MANIFEST__[entry]) == null ? void 0 : _a[slot] : entry[slot];
      if (parts) {
...
_marko_template$1._ = _marko_renderer(function(input, out, _componentDef, _component, state) {
  ...
  _marko_tag(_flush_here_and_after__, {
    "renderBody": (out2) => {
      out2.w(_marko_to_string($global.___viteRenderAssets(input.slot)));
    }
  }, out, _componentDef, "0");
}, {
...
const _marko_componentType = "/iZwvCL0", _marko_template = t(_marko_componentType);
var template = _marko_template;
const _marko_component = {};
_marko_template._ = _marko_renderer(function(input, out, _componentDef, _component, state) {
  const $global = out.global;
  ($global.___viteEntries || ($global.___viteEntries = [])).push("template_sLa5");
...
export { app };
;var __MARKO_MANIFEST__={"template_sLa5":{"head-prepend":null,"head":["<script"," async type=\"module\" crossorigin src=\"/assets/index.marko.03da906e.js\"></script><link"," rel=\"stylesheet\" href=\"/assets/index.marko.994f5f93.css\">"],"body-prepend":null,"body":null}};
